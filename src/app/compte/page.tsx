...
export default async function AccountPage() {
  ...
  return (
    <main className="accountPage">
      ...
      <section className="accountHero"><div className="accountAvatar">{initial}</div><div><span className="eyebrow">Mon espace</span><h1>Bonjour, {user.displayName}</h1><p>{user.email}</p></div></section>
      <div className="accountLayout">
        ...
        <section className="accountContent">
          <div className="accountStats">
            <a href="/mes-annonces"><strong>{user._count.listings}</strong><span>Annonces publiées</span></a>
            <a href="/favoris"><strong>{user._count.favorites}</strong><span>Favoris</span></a>
