...
export default async function MyListingsPage() {
  ...
  const listings = await prisma.listing.findMany({
    ...
    include: { territory: { select: { name: true } }, category: { select: { name: true, slug: true, icon: true } }, images: { orderBy: { position: "asc" }, take: 1 }, _count: { select: { favorites: true, conversations: true } } },
  });
